...
function firstQuestion() {
    ...
    Swal.fire({
        ...
        imageWidth: 300,
        imageHeight: 300,
        background: '#fff url("img/may.webp")',
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        width: 900,
        padding: '3em',
        html: "<input type='text' class='form-control' id='txtReason' onmousemove=textGenerate()  placeholder='Nghe nhạc tí đi nàng😎, xích thì nhập gì zdô này chơi củm đc😆'>",
        background: '#fff url("img/may.webp")',
        backdrop: `
              rgba(0,0,150,0.4)
              url("img/200.webp")
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("img/img/may.webp")',
                title: CONFIG.mess,
